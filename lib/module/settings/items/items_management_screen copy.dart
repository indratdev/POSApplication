...
class ItemsManagementScreen_COPY extends StatefulWidget {
  bool isUpdate;
  ItemsModel? itemsModel;

  ItemsManagementScreen_COPY({
    super.key,
    this.isUpdate = false,
    this.itemsModel,
  });
  ...
  @override
  State<ItemsManagementScreen_COPY> createState() =>
      _ItemsManagementScreen_COPYState();
}

class _ItemsManagementScreen_COPYState
    extends State<ItemsManagementScreen_COPY> {
        ...
        builder: (context, state) {
          ...
          if (state is SuccessGetAllCategory) {
            ...
            if (listCategory.isEmpty) {
              CustomWidgets.showMessageAlertWithF(context,
                  "Kategori Belum Ada !, Silahkan Daftarkan Dahulu", false, () {
                GeneralFunction.navigationBackTwoStep(context);
              });
            }
...
//   @override
//   State<ItemsManagementScreen_COPY> createState() => _ItemsManagementScreen_COPYState();
// }

// class _ItemsManagementScreen_COPYState extends State<ItemsManagementScreen_COPY> {
//   final _formKeyItemsManage = GlobalKey<FormState>();
//   TextEditingController itemsNameController = TextEditingController();
//   TextEditingController nameCategoryController = TextEditingController();
//   TextEditingController sellByController = TextEditingController();
